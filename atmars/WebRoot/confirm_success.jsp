...
<div class="container">
  ...
  <div class="content">
    ...
    <div style="float:left; line-height:80px; font-family:'Comic Sans MS', cursive; font-size:36px">&nbsp;&nbsp; Register Success<br></div>
    <div style="float:left; margin-left:80px; margin-right:80px; font-family:'Comic Sans MS', cursive;">
    <p>&nbsp;&nbsp;&nbsp;&nbsp;<br />redirect to homepage in 5 seconds...</p>
    </div>
